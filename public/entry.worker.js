...
const routes = {
  ...
  "routes/api.patient.search": {
    id: "routes/api.patient.search",
    parentId: "routes/api.patient",
    path: "search",
    index: void 0,
    caseSensitive: void 0,
    hasLoader: true,
  ...
  "routes/exams.$examId.edit": {
    id: "routes/exams.$examId.edit",
    parentId: "root",
  ...
  "routes/api.exams._index": {
    id: "routes/api.exams._index",
    parentId: "root",
    path: "api/exams",
    index: true,
    caseSensitive: void 0,
  ...
  "routes/api.patients.$id": {
    id: "routes/api.patients.$id",
    parentId: "root",
